...
export default function EventsPage() {
  ...
  const renderEventRow = (item: EventItem) => (
    <TableRow key={item.id} sx={eventRowSx}>
      <TableCell>
        <Stack direction="row" alignItems="center" gap={1}>
          ...
          <Typography
            ...
            onClick={() => navigate(`/library/events/${item.id}`)}
          >
            {item.name}
          </Typography>
        </Stack>
          ...
          >
            <TableHead>
              <TableRow>
                ...
                <TableCell sx={{ width: "18%" }}>Modified by</TableCell>
            ...
            <TableBody>
              {filteredItems.length === 0 ? (
                ...
                filteredItems.map(renderEventRow)
              )}
            </TableBody>
          </Table>
        </Box>
